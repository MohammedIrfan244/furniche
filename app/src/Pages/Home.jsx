...
function Home() {
  ...
  return (
    ...
    <div className="w-[100%] sm:w-[50%] flex items-center justify-center">
      ...
      <p className="text-2xl sm:text-3xl font-serif">Where Design Meets Comfort
      </p>
      <Link to={`${currentUser?"/collection":"/login"}`} className=" flex items-baseline"><FontAwesomeIcon className="text-[#A47C48]" icon={faShop}/>. Shop now .<hr className="bg-[#A47C48] h-[3px] w-[15%]"/></Link>
      </div>
    </div>
    </Hero>
    <NewCollection/>
