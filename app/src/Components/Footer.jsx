  ...
  return (
    ...
    <div className="my-20 flex justify-between pt-5 border-t-2 border-[#544A3E] px-3">
      <div className="w-[40%] text-left">
        <h1 className="font-serif text-sm sm:text-md md:text-lg" style={{textShadow:'0 0 1px #000000'}}>Settle.com</h1>
    ...
    <p className="text-center text-xs mb-2 font-bold">&copy; 2024 Settle.com . All Rights Reserved</p>
    </>
  );
}
