...
function OurPolicy() {
  return (
    ...
    <h1 className="flex items-baseline text-xl my-20">OUR POLICIES<hr className="w-10 h-[3px] bg-[#D65F0D]" /></h1>
    <div className="flex flex-col items-center text-center sm:flex-row justify-between sm:px-10">
       ...
       <p className="text-xs mt-2">Our customer support team is available 24/7 to assist you with any inquiries or issues. You can reach us through <Link to={'/contact'} className="text-[#D65F0D] text-sm">email</Link>, and we strive to respond within 3 days.</p>
       </div>
    </div>
    </div>
  )
