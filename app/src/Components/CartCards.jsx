  ...
  return (
    <div className="flex justify-between gap-[10px] border-b-2 border-gray-300 pe-[2%] pb-[1%]" >
      <div className="flex gap-4">
        <img className="h-[100px] w-[150px] object-cover cartCard" src={image} alt="image" />
        ...
        <input className="min-w-1 bg-[#F5F2E9] text-center lg:ps-3 focus:outline-none" value={count}  type="number" min={1} readOnly />
